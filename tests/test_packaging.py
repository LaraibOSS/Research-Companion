...
def test_pyproject_version_is_0_5_9():
    """pyproject.toml version must be 0.5.9."""
    data = _load_pyproject()
    assert data["project"]["version"] == "0.5.9", (
        f"Expected version 0.5.9, got {data['project']['version']!r}"
    )
