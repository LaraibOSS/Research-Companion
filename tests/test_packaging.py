...
def test_pyproject_version_is_0_5_11():
    """pyproject.toml version must be 0.5.11."""
    data = _load_pyproject()
    assert data["project"]["version"] == "0.5.11", (
        f"Expected version 0.5.11, got {data['project']['version']!r}"
    )
