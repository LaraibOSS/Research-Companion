...
def test_pyproject_version_is_0_5_16():
    """pyproject.toml version must be 0.5.16."""
    data = _load_pyproject()
    assert data["project"]["version"] == "0.5.16", (
        f"Expected version 0.5.16, got {data['project']['version']!r}"
    )
