...
def test_pyproject_version_is_0_5_10():
    """pyproject.toml version must be 0.5.10."""
    data = _load_pyproject()
    assert data["project"]["version"] == "0.5.10", (
        f"Expected version 0.5.10, got {data['project']['version']!r}"
    )
