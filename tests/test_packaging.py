...
def test_pyproject_version_is_0_5_17():
    """pyproject.toml version must be 0.5.17."""
    data = _load_pyproject()
    assert data["project"]["version"] == "0.5.17", (
        f"Expected version 0.5.17, got {data['project']['version']!r}"
    )
