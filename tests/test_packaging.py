...
def test_pyproject_version_is_0_5_13():
    """pyproject.toml version must be 0.5.13."""
    data = _load_pyproject()
    assert data["project"]["version"] == "0.5.13", (
        f"Expected version 0.5.13, got {data['project']['version']!r}"
    )
