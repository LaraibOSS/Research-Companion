...
def test_pyproject_version_is_0_5_4():
    """pyproject.toml version must be 0.5.4."""
    data = _load_pyproject()
    assert data["project"]["version"] == "0.5.4", (
        f"Expected version 0.5.4, got {data['project']['version']!r}"
    )
