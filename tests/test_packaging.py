...
def test_pyproject_version_is_0_5_3():
    """pyproject.toml version must be 0.5.3."""
    data = _load_pyproject()
    assert data["project"]["version"] == "0.5.3", (
        f"Expected version 0.5.3, got {data['project']['version']!r}"
    )
