...
def test_pyproject_version_is_0_5_12():
    """pyproject.toml version must be 0.5.12."""
    data = _load_pyproject()
    assert data["project"]["version"] == "0.5.12", (
        f"Expected version 0.5.12, got {data['project']['version']!r}"
    )
