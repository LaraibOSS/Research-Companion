...
def render_report_html(report: dict) -> str:
    ...
    preferred_order = ["severity", "venuefit", "ingest", "citation", "citation_polarity", "priorart", "novelty", "confidence", "statsoundness", "reproducibility", "ethics", "overlap", "benchmark", "rebuttal"]
    ordered_lanes = []
