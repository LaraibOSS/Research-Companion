...
from research_companion.rebuttal.verify import verify_quote as _vq
...
class NoveltyAgent(Agent):
    ...
    async def run(self, ctx: AgentContext) -> AgentResult:
        from research_companion.prompts import format_comparison_prompt, format_contribution_prompt
