...
from research_companion.rebuttal.models import Concern, RebuttalReport, ResponseDraft
from research_companion.rebuttal.retrieve import retrieve_passages
from research_companion.rebuttal.verify import verify_reply_quotes
...
def draft_rebuttal(
    ...
    from research_companion.prompts import format_classify_prompt, format_rebuttal_prompt
