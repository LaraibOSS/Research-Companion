...
<div class="settings-view">
  ...
  <div class="settings-card" id="sc-about">
    ...
    <div style="display:flex;flex-direction:column;gap:var(--space-2)">
      <a href="/static/guide.pdf" target="_blank" rel="noopener" class="settings-label" style="color:var(--color-accent)">PDF User Guide &#8599;</a>
      <a href="https://github.com" target="_blank" rel="noopener" class="settings-label" style="color:var(--color-accent)">GitHub Repository &#8599;</a>
