"""Local persistence for papergraph.

Layout under PAPERGRAPH_DIR (default: ~/.papergraph/):
...
def papergraph_dir() -> Path:
    """Root directory for papergraph state. Override with $PAPERGRAPH_DIR."""
    custom = os.environ.get("PAPERGRAPH_DIR")
    if custom:
        return Path(custom)
    home = Path(os.environ.get("USERPROFILE") or os.environ.get("HOME") or ".")
    return home / ".papergraph"
